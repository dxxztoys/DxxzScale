...
//% block="电子秤模块" weight=100 color=#ff8f3f icon="\uf24e"
namespace HX711 {
    ...
    //% blockId="SET_DOUT" block="设置电子秤DAT引脚 %pinDOUT"
     ...
     */
    //% blockId="SET_SCK" block="设置电子秤SCK引脚 %pinPD_SCK"
    //% weight=100 blockGap=8
    ...
    //% blockId="HX711_BEGIN" block="启动称重"
    ...
    //% blockId="HX711_GET_UNITS" block="读取重量(g)"
    //% weight=80 blockGap=8
    ...
    //% blockId="HX711_SET_SCALE" block="设置校准因子 %scale"
    //% weight=80 blockGap=8
...
/**
    //% blockId="HX711_GET_SCALE" block="读取比例系数"
    //% weight=80 blockGap=8
    export function get_scale(): number {
        return SCALE
    }
**/
    //% blockId="HX711_SET_OFFSET" block="设置补偿值 %offset"
    //% weight=80 blockGap=8
...
/**
    //% blockId="HX711_GET_OFFSET" block="读取补偿值"
    //% weight=80 blockGap=8
    export function get_offset(): number {
        return OFFSET
    }
**/
    //% blockId="HX711_DOWN" block="关机"
